...
@section('title', 'Tambah Ruangan Baru - Sistem Manajemen Ruangan')
            ...
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <h1 class="text-xl font-bold text-gray-900">RoomManager</h1>
                            <p class="text-xs text-gray-500">Sistem Manajemen Ruangan</p>
                        </div>
                    </div>
                    
                    <!-- Navigation Links -->
                    <nav class="hidden md:flex space-x-6">
                        <a href="{{ route('rooms.index') }}" class="text-gray-500 hover:text-gray-700 font-medium transition duration-150">
                            <i class="fas fa-list mr-2"></i>Daftar Ruangan
                        </a>
                        <a href="#" class="text-green-600 font-medium border-b-2 border-green-600 pb-1">
                            <i class="fas fa-plus-circle mr-2"></i>Tambah Baru
                        </a>
                        <a href="#" class="text-gray-500 hover:text-gray-700 font-medium transition duration-150">
